...
describe("DataType", () => {
  describe("#parseNumber()", () => {
    function parseInt32(value: any): number {
      return DataType.parseNumber(value, DataType.Int32);
    }

    function parseFloat(value: any): number {
      return DataType.parseNumber(value, DataType.Float);
    }

    function parseLocKey(value: any): number {
      return DataType.parseNumber(value, DataType.LocalizationKey);
    }
